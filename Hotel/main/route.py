...
def hotels_detail(hotel_id):
    ...
    return jsonify(
        bestsellers=hotels.bestsellers,
        closing_time=hotels.closing_time,
        ...
        hotel_pic=hotels.hotel_pic,
        no_eightseater=hotels.no_eightseater,
        no_fourseater=hotels.no_fourseater,
        no_sixseater=hotels.no_sixseater,
        no_twoseater=hotels.no_twoseater,
        no_waiter=hotels.no_waiter,
        opening_time=hotels.opening_time,
        special_friday=hotels.special_friday,
        special_monday=hotels.special_monday,
        special_saturday=hotels.special_saturday,
        special_sunday=hotels.special_sunday,
        special_thursday=hotels.special_thursday,
        special_tuesday=hotels.special_tuesday,
        special_wednesday=hotels.special_wednesday,
        user_id=hotels.user_id,
    )
...
def make_transaction():
    ...
    new_transaction = Transaction(
        table_id, user_id, waiter_id, hotel_id, cost, order_id, date_time, booking_id
    )
